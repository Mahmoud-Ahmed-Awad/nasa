        ...
        >
          ...
          <div className="text-center">
            ...
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              className="mt-4 inline-flex items-center gap-2 px-4 py-2 bg-blue-600/10 border border-blue-600/20 rounded-full"
            >
            ...
            {error && (
              ...
              >
                ...
                <span className="text-yellow-400 text-xs">
                  Using offline data - NASA APIs temporarily unavailable
                </span>
              </motion.div>
            )}
          </div>
