...
const AI = () => {
  ...
  const chatMutation = useMutation({
    mutationFn: async (userMessage) => {
      ...
      const responses = {
        'james webb': "The James Webb Space Telescope is NASA's most powerful space telescope ever built. It was launched in December 2021 and is designed to study the formation of stars and planets, investigate the origins of life, and observe the first galaxies formed after the Big Bang.",
        'exoplanet': "Exoplanets are planets that orbit stars outside our solar system. Scientists have discovered over 5,000 confirmed exoplanets using various detection methods including the transit method and radial velocity method.",
        ...
        'default': "I'm NASA Explorer's AI assistant! I can help you learn about space missions, exoplanets, satellites, and other space-related topics. Feel free to ask me anything about space exploration, NASA missions, or astronomy!"
      }

      const lowerMessage = userMessage.toLowerCase()
      let response = responses.default

      if (lowerMessage.includes('james webb') || lowerMessage.includes('webb')) {
      ...
      } else if (lowerMessage.includes('iss') || lowerMessage.includes('space station')) {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3">
              <div className="card h-[600px] flex flex-col">
                ...
                <div className="flex items-center space-x-3 p-4 border-b border-slate-700">
                  ...
                  <div>
                    <h3 className="text-white font-semibold">NASA Explorer AI</h3>
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-4">
                  {chatHistory.length === 0 ? (
                    <div className="text-center py-8">
                      ...
                      <h3 className="text-xl font-semibold text-white mb-2">Welcome to NASA Explorer AI!</h3>
                      <p className="text-slate-400">Ask me anything about space, NASA missions, or astronomy.</p>
                    </div>
                  ) : (
                    <AnimatePresence>
            ...
            <div className="space-y-6">
              ...
              <div className="card">
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-slate-300 text-sm">Space Mission Information</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-neon-green rounded-full"></div>
                    <span className="text-slate-300 text-sm">Exoplanet Data</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-neon-green rounded-full"></div>
                    <span className="text-slate-300 text-sm">Satellite Tracking</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-neon-green rounded-full"></div>
                    <span className="text-slate-300 text-sm">Astronomy Facts</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-neon-green rounded-full"></div>
              ...
              <div className="card">
                ...
                <div className="space-y-3">
                  <button
                    onClick={() => setMessage("Tell me about the latest NASA missions")}
                    className="w-full text-left p-3 bg-slate-700 hover:bg-slate-600 rounded-lg transition-colors duration-300"
                  >
                    <span className="text-slate-300 text-sm">Latest Missions</span>
                  </button>
                  <button
                    onClick={() => setMessage("What are the most interesting exoplanets discovered recently?")}
                    className="w-full text-left p-3 bg-slate-700 hover:bg-slate-600 rounded-lg transition-colors duration-300"
                  >
                    <span className="text-slate-300 text-sm">Recent Exoplanets</span>
                  </button>
                  <button
                    onClick={() => setMessage("How can I track satellites in real-time?")}
                    className="w-full text-left p-3 bg-slate-700 hover:bg-slate-600 rounded-lg transition-colors duration-300"
                  >
                    <span className="text-slate-300 text-sm">Satellite Tracking</span>
                  </button>
